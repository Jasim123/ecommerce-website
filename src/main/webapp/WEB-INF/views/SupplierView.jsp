					...
					<div class="col-sm-12">
						<div class="row">
							<div class="col-sm-6 form-group">
								...
								<form:input  path="sid" placeholder="" class="form-control" ></form:input>
							</div>
							<div class="col-sm-6 form-group">
						...
						<div class="form-group">
							...
							<form:textarea path="address" placeholder="" rows="3" class="form-control"></form:textarea>
						</div>	
				...
				<form:form method="post" action="UpdateSupplier" commandName="Supplier">
					<div class="col-sm-12">
						<div class="row">
							<div class="col-sm-6 form-group">
								<label>Supplier Id</label>
								<form:input  path="sid" placeholder="" class="form-control" readonly="true"></form:input>
							</div>
							<div class="col-sm-6 form-group">
								<label>Supplier Name</label>
								<form:input type="text" path="name" placeholder="" class="form-control"></form:input>
